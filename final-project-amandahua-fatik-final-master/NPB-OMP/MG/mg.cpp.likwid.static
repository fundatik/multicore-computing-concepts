...
#pragma omp single
    ...
    likwid_init();
    likwid_named_marker_init("mg_bench");
...
#define X 314159265.e0
    ...
    #pragma omp parallel for schedule(static) private(i2, i1)
    for (i3 = 0; i3 < n3; i3++)
    {
        for (i2 = 0; i2 < n2; i2++)
        {
